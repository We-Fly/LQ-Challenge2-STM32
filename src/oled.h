...
#define OLED_GPIO_CLK_ENABLE()  __HAL_RCC_GPIOC_CLK_ENABLE()

#define OLED_SCLK_Clr() HAL_GPIO_WritePin(OLED_SCL_GPIO_PORT,OLED_SCL_PIN,GPIO_PIN_RESET)//SCL IIC接口的时钟信号
#define OLED_SCLK_Set() HAL_GPIO_WritePin(OLED_SCL_GPIO_PORT,OLED_SCL_PIN,GPIO_PIN_SET)

#define OLED_SDIN_Clr() HAL_GPIO_WritePin(OLED_SDA_GPIO_PORT,OLED_SDA_PIN,GPIO_PIN_RESET)//SDA IIC接口的数据信号
